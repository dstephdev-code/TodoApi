...
namespace TodoApp.Tests
{
    ...
    {
        private readonly ITodoTaskRepository _taskRepositoryMock;
        ...
        {
            _taskRepositoryMock = Substitute.For<ITodoTaskRepository>();
            _userRepositoryMock = Substitute.For<IUserRepository>();
            _loggerMock = Substitute.For<ILogger<TodoTasksService>>();
            _service = new TodoTasksService(_taskRepositoryMock, _userRepositoryMock, _loggerMock);
        }
        ...
        public async Task GetByIdAsync_WhenTaskExists_ReturnsMappedTaskResponse()
        {
            ...
            _taskRepositoryMock.GetByIdAsync(taskId, cancellationToken).Returns(existingTask);
            ...
            await _taskRepositoryMock.Received(1).GetByIdAsync(taskId, cancellationToken);
        }
        ...
        public async Task GetByIdAsync_WhenTaskDoesNotExist_ThrowsNotFoundException()
        {
            ...
            _taskRepositoryMock.GetByIdAsync(taskId, cancellationToken).Returns((TodoTask?)null);
        ...
        public async Task CreateAsync_WithValidDTO_SavesTaskAndReturnsResponse()
        {
            ...
            await _taskRepositoryMock.Received(1).AddAsync(Arg.Any<TodoTask>(), cancellationToken);
            await _taskRepositoryMock.Received(1).SaveChangesAsync(cancellationToken);
        }
        ...
        public async Task GetAllAsync_WithFilters_ReturnsMappedCollection()
        {
            ...
            _taskRepositoryMock.GetAllAsync(query, cancellationToken).Returns(repoResult);
            ...
            await _taskRepositoryMock.Received(1).GetAllAsync(query, cancellationToken);
        }
        ...
        public async Task GetAllAsync_WithEmptyFilters_ReturnsAllTasks()
        {
            ...
            _taskRepositoryMock.GetAllAsync(emptyQuery, cancellationToken).Returns(repoResult);
            ...
            await _taskRepositoryMock.Received(1).GetAllAsync(emptyQuery, cancellationToken);
        }
    }
}
